...
viewModeMenu =
    div []
        [ h4
            [ class "center-align hit-the-floor" ]
            [ text "Choose game mode" ]
        , hr [] []
        , div [ class "row" ] []
        , div [ class "row" ] []
        , div [ class "card hoverable teal lighten-2 add-pointer", onClick (ChangeMode MultipleChoiceQuestions) ]
            [ div [ class "card-content white-text" ] [ span [ class "card-title" ] [ p [ class "center-align" ] [ text "Multiple Choice Questions" ] ] ] ]
        , div [ class "card hoverable teal lighten-2 add-pointer", onClick (ChangeMode LandmarkQuestions) ]
            [ div [ class "card-content white-text" ] [ span [ class "card-title" ] [ p [ class "center-align" ] [ text "Landmark Questions" ] ] ] ]
        , div [ class "card hoverable teal lighten-2 add-pointer", onClick (ChangeMode OutlineQuestions) ]
            [ div [ class "card-content white-text" ] [ span [ class "card-title" ] [ p [ class "center-align" ] [ text "Outline Questions" ] ] ] ]
