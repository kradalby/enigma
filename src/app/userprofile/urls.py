...
urlpatterns = [
    ...
    url(r'^admin/user/(?P<user_id>\d+)/addgroup$',
        users.list_groups_user_is_not_member_of,
        name='admin_list_groups_user_is_not_member_of'),
    url(r'^admin/user/(?P<user_id>\d+)/resetpassword$',
        users.reset_password_for_user,
    ...
    url(r'^admin/group/(?P<group_id>\d+)/$',
        groups.view_group,
        name='admin_view_group'),
    url(r'^admin/group/(?P<group_id>\d+)/delete/$',
        groups.delete_group,
        name='admin_delete_group'),
    url(r'^admin/group/(?P<group_id>\d+)/addgroup$',
        groups.list_users_not_in_group,
        name='admin_list_users_not_in_group'),
    url(r'^admin/group/(?P<group_id>\d+)/register/(?P<user_id>\d+)$',
        groups.register_user_in_group,
        name='admin_register_user_in_group'),
    url(r'^admin/group/(?P<group_id>\d+)/unregister/(?P<user_id>\d+)$',
        groups.unregister_user_from_group,
        name='admin_unregister_user_from_group'),
    url(r'^admin/group/(?P<group_id>\d+)/generateuser$',
        groups.generate_user_for_group,
        name='admin_generate_user_for_group'),
    url(r'^admin/group/print/(?P<group_id>\d+)/$',
        groups.group_print_preview,
        name='admin_group_print_preview'),
    url(r'^admin/group/(?P<group_id>\d+)/remove_user/(?P<user_id>\d+)/$',
        groups.remove_user_from_group,
